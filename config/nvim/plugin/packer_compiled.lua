...
vim.cmd [[au FileType xml ++once lua require("packer.load")({'html5.vim', 'MatchTagAlways', 'vim-autoformat', 'emmet-vim'}, { ft = "xml" }, _G.packer_plugins)]]
vim.cmd [[au FileType htmldjango ++once lua require("packer.load")({'html5.vim', 'MatchTagAlways', 'emmet-vim'}, { ft = "htmldjango" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType c ++once lua require("packer.load")({'cscope_maps', 'ale', 'vim-autoformat', 'a.vim'}, { ft = "c" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType cpp ++once lua require("packer.load")({'cscope_maps', 'ale', 'vim-autoformat', 'a.vim'}, { ft = "cpp" }, _G.packer_plugins)]]
vim.cmd [[au FileType cmake ++once lua require("packer.load")({'ale'}, { ft = "cmake" }, _G.packer_plugins)]]
vim.cmd [[au FileType html ++once lua require("packer.load")({'html5.vim', 'MatchTagAlways', 'ale', 'vim-autoformat', 'emmet-vim'}, { ft = "html" }, _G.packer_plugins)]]
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'vim-markdown', 'ale', 'vim-markdown-folding'}, { ft = "markdown" }, _G.packer_plugins)]]
